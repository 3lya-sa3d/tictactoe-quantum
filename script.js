document.addEventListener('DOMContentLoaded', () => {
    ...
    async function collapseMove(move, cell1Index, cell2Index) {
        ...
        try {
            ...
            messageArea.textContent = 'Error during collapse. Check console for details.';
        }
    }
    ...
    function checkWinCondition() {
        ...
        // Check for draw
        const allCellsFilled = gameState.board.every(cell => 
            cell.classical !== null || cell.quantum.length > 0
        );
